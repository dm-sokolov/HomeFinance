...
namespace HF.Web.Models
{
    public class TransactionViewModel
    {
        ...
        [DisplayName("Тип операции")] public Operation Operation { get; set; }
        ...
        public string TransactionCategoriesToString =>
            string.Join(", ", TransactionCategories.Select(s => s.Category.Name));
